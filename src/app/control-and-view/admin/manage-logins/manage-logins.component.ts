...
@Component({
  ...
  styleUrls: ['./manage-logins.component.scss']
})
export class ManageLoginsComponent implements OnInit {
  ...
  constructor(private peopleServiceService: PeopleServiceService, private formBuilder: FormBuilder, private el: ElementRef, private dst: DataServiceTokenStorageService) { }
  ...
  // Function to search the users from the list
