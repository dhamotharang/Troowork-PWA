...
@NgModule({
  ...
  declarations: [
    // CreateOrganizationComponent, ViewOrganizationComponent, EditOrganizationComponent, 
    // ManualCronJobComponent, ViewCronJobComponent, CronJobBatchDetailsComponent
  ]
})
