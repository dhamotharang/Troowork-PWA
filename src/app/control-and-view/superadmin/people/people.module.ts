...
@NgModule({
  ...
  declarations: [
    // ViewemployeeComponent, CreateemployeeComponent, ManagelogincredentialsComponent, EditemployeeComponent, 
    // ResetpasswordforsamoduleComponent, SetUsnamepaswdbySAComponent, SetUserLoginSuperComponent
  ]
})
